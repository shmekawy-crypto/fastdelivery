<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="Roles.aspx.cs" Inherits="Admin_Pages_Roles" Title=" رتب المستخدمين" %>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									...
									<header>بيانات رتب المستخدمين</header>
...
<div class="form-group row">
	...
	<div class="row">
	<div class="col-sm-12">
											   <asp:GridView ID="gvRoles"  OnRowCommand="gvRoles_RowCommand"   runat="server" AutoGenerateColumns="False"  PagerSettings-Mode="NumericFirstLast" AllowSorting="true"
          GridLines="None"   OnPageIndexChanging="gvRoles_PageIndexChanging"
    ...
    <PagerStyle CssClass="bs4-aspnet-pager" />
                            <Columns>
                                <asp:BoundField HeaderText="الإسم بالعربية" DataField="NameAr" />
                                ...
                                <asp:TemplateField HeaderText="التحكم">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lbEdit" runat="server" CommandName="EditRoles" 
                        CommandArgument='<%#Eval("ID") %>' class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></asp:LinkButton>
                                        &nbsp;<asp:LinkButton ID="lbDelete" runat="server" CommandName="DeleteRoles"  class="btn btn-xs btn-danger"
