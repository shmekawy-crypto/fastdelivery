<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="gov.aspx.cs" Inherits="Admin_Pages_Gov" Title=" المحافظات" %>
						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									...
									<header>بيانات المحافظات</header>
...
<div class="form-group row">
	...
	<div class="row">
	<div class="col-sm-12">
											   <asp:GridView ID="gvGov"  OnRowCommand="gvGov_RowCommand"   runat="server" AutoGenerateColumns="False"  PagerSettings-Mode="NumericFirstLast" AllowSorting="true"
          GridLines="None"   OnPageIndexChanging="gvGov_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="التحكم">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="lbEdit" runat="server" CommandName="EditGov" 
                        CommandArgument='<%#Eval("ID") %>' class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></asp:LinkButton>
                                        &nbsp;<asp:LinkButton ID="lbDelete" runat="server" CommandName="DeleteGov"  class="btn btn-xs btn-danger"
