...
namespace DMS
{
	...
	abstract public class DynamicQuery
	{
		...
		///
        /// 	' Sort
        /// 	prds.Query.AddOrderBy(prds.ColumnNames.ProductName,  LMS.WhereParameter.Dir.ASC)
		/// 	
        /// 	' Load it
        /// 	prds.Query.Load()
		/// 	
		...
		///
		/// 	// Sort
		/// 	prds.Query.AddOrderBy(Products.ColumnNames.ProductName,  LMS.WhereParameter.Dir.ASC);
		/// 	
		/// 	// Load it
		/// 	prds.Query.Load();
		///
