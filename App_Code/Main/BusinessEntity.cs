...
// OR PERFORMANCE OF THIS SOFTWARE. aw
...
namespace DMS
{
    ...
    abstract public class BusinessEntity
    {
        ...
        private static string _defaultConfig = ConfigurationManager.ConnectionStrings["Conn"].ConnectionString;
        internal string _config = BusinessEntity._defaultConfig;
        internal IDbConnection _notRecommendedConnection = null;
        internal string _raw = ConfigurationManager.ConnectionStrings["Conn"].ConnectionString;
