...
namespace DMS
{
	...
	public class SqlClientDynamicQuery : DynamicQuery
	{
		...
		public override void AddOrderBy(string column, DMS.WhereParameter.Dir direction)
		{
			base.AddOrderBy ("[" + column + "]", direction);
		}

		public override void AddOrderBy(DynamicQuery countAll,  DMS.WhereParameter.Dir direction)
		{
		...
		public override void AddOrderBy(AggregateParameter aggregate,  DMS.WhereParameter.Dir direction)
		{
